...
if [[ "$1" == "install" ]]; then
  ...
  if [[ "$npm_config_user_agent" =~ ^npm/ ]]; then
    ...
    echo "${ORANGE}║${RESET}   ${GREEN}│${RESET}     ${CYAN}$ pnpm install${RESET}         ${GRAY}← Yeh use kar, intelligent ban!${RESET}    ${GREEN}│${RESET}       ${ORANGE}║${RESET}"
    echo "${ORANGE}║${RESET}   ${GREEN}│${RESET}     ${CYAN}$ bun install${RESET}         ${GRAY}← Ya yeh bhi chalega${RESET}             ${GREEN}│${RESET}       ${ORANGE}║${RESET}"
    echo "${ORANGE}║${RESET}   ${GREEN}│${RESET}                                                              ${GREEN}│${RESET}       ${ORANGE}║${RESET}"
    echo "${ORANGE}║${RESET}   ${GREEN}└──────────────────────────────────────────────────────────────┘${RESET}       ${ORANGE}║${RESET}"
    echo "${ORANGE}║${RESET}                                                                              ${ORANGE}║${RESET}"
    echo "${ORANGE}║${RESET}            ${PURPLE}« AJA BETA, PNPM SIKHA DOON TUJHE FREE MEIN »${RESET}                 ${ORANGE}║${RESET}"
    echo "${ORANGE}║${RESET}                                                                              ${ORANGE}║${RESET}"
    echo "${ORANGE}╚══════════════════════════════════════════════════════════════════════════════╝${RESET}"
    echo ""
    exit 1
  ...
  if [[ "$npm_config_user_agent" =~ ^yarn/ ]]; then
    ...
    echo "${RED}║${RESET}                                                                              ${RED}║${RESET}"
    echo "${RED}║${RESET}   ${MAGENTA}Teri mummy ko bulaaun? Woh bhi pnpm use karti hai! 👩${RESET}                 ${RED}║${RESET}"
    echo "${RED}║${RESET}                                                                              ${RED}║${RESET}"
    echo "${RED}╠══════════════════════════════════════════════════════════════════════════════╣${RESET}"
    echo "${RED}║${RESET}                                                                              ${RED}║${RESET}"
    ...
    echo "${RED}║${RESET}   ${GREEN}│${RESET}     ${CYAN}$ pnpm install${RESET}         ${GRAY}← Industry standard hai yeh${RESET}       ${GREEN}│${RESET}       ${RED}║${RESET}"
    echo "${RED}║${RESET}   ${GREEN}│${RESET}     ${CYAN}$ bun install${RESET}         ${GRAY}← Future-proof solution${RESET}          ${GREEN}│${RESET}       ${RED}║${RESET}"
    echo "${RED}║${RESET}   ${GREEN}│${RESET}                                                              ${GREEN}│${RESET}       ${RED}║${RESET}"
    echo "${RED}║${RESET}   ${GREEN}└──────────────────────────────────────────────────────────────┘${RESET}       ${RED}║${RESET}"
    echo "${RED}║${RESET}                                                                              ${RED}║${RESET}"
    echo "${RED}║${RESET}              ${PURPLE}« YARN CHHOD, PNPM PAKAD - LIFE SET! »${RESET}                      ${RED}║${RESET}"
    echo "${RED}║${RESET}                                                                              ${RED}║${RESET}"
    echo "${RED}╚══════════════════════════════════════════════════════════════════════════════╝${RESET}"
    echo ""
    exit 1
  ...
  # All good for install - pnpm, bun, deno, etc. are allowed
  exit 0
fi
...
if [[ "$npm_config_user_agent" =~ ^npm/ ]]; then
  ...
  echo "${ORANGE}║${RESET}   ${GREEN}│${RESET}  ${YELLOW}🎯 SAHI TARIKA (The Right Way):${RESET}                              ${GREEN}│${RESET}       ${ORANGE}║${RESET}"
  echo "${ORANGE}║${RESET}   ${GREEN}│${RESET}                                                              ${GREEN}│${RESET}       ${ORANGE}║${RESET}"
  echo "${ORANGE}║${RESET}   ${GREEN}│${RESET}     ${CYAN}$ pnpm ${SCRIPT_NAME}${RESET}         ${GRAY}← Yeh use kar, intelligent ban!${RESET}    ${GREEN}│${RESET}       ${ORANGE}║${RESET}"
  echo "${ORANGE}║${RESET}   ${GREEN}│${RESET}     ${CYAN}$ bun run ${SCRIPT_NAME}${RESET}      ${GRAY}← Ya yeh bhi chalega${RESET}             ${GREEN}│${RESET}       ${ORANGE}║${RESET}"
  echo "${ORANGE}║${RESET}   ${GREEN}│${RESET}                                                              ${GREEN}│${RESET}       ${ORANGE}║${RESET}"
  echo "${ORANGE}║${RESET}   ${GREEN}└──────────────────────────────────────────────────────────────┘${RESET}       ${ORANGE}║${RESET}"
  echo "${ORANGE}║${RESET}                                                                              ${ORANGE}║${RESET}"
  echo "${ORANGE}║${RESET}            ${PURPLE}« AJA BETA, PNPM SIKHA DOON TUJHE FREE MEIN »${RESET}                 ${ORANGE}║${RESET}"
...
if [[ "$npm_config_user_agent" =~ ^yarn/ ]]; then
  ...
  echo "${RED}║${RESET}   ${GREEN}│${RESET}  ${YELLOW}✨ SUDHAR JA BETA (Reform Yourself):${RESET}                         ${GREEN}│${RESET}       ${RED}║${RESET}"
  echo "${RED}║${RESET}   ${GREEN}│${RESET}                                                              ${GREEN}│${RESET}       ${RED}║${RESET}"
  echo "${RED}║${RESET}   ${GREEN}│${RESET}     ${CYAN}$ pnpm ${SCRIPT_NAME}${RESET}         ${GRAY}← Industry standard hai yeh${RESET}       ${GREEN}│${RESET}       ${RED}║${RESET}"
  echo "${RED}║${RESET}   ${GREEN}│${RESET}     ${CYAN}$ bun run ${SCRIPT_NAME}${RESET}      ${GRAY}← Future-proof solution${RESET}          ${GREEN}│${RESET}       ${RED}║${RESET}"
  echo "${RED}║${RESET}   ${GREEN}│${RESET}                                                              ${GREEN}│${RESET}       ${RED}║${RESET}"
  echo "${RED}║${RESET}   ${GREEN}└──────────────────────────────────────────────────────────────┘${RESET}       ${RED}║${RESET}"
  echo "${RED}║${RESET}                                                                              ${RED}║${RESET}"
  echo "${RED}║${RESET}              ${PURPLE}« YARN CHHOD, PNPM PAKAD - LIFE SET! »${RESET}                      ${RED}║${RESET}"
...
# All good - pnpm, bun, deno, etc. are allowed
exit 0
