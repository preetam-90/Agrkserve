    ...
    return (
        <div>
            ...
            <div className="flex items-start justify-between mb-6">
                ...
                <span className={`admin-badge text-lg px-4 py-2 ${STATUS_COLORS[booking.status]}`}>
                        ...
                        <div className="admin-card">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-mono">{payment.transaction_id || 'N/A'}</p>
                                </div>
                                <div>
                        ...
                        <div className="space-y-2">
                            {BOOKING_STATUS_OPTIONS.filter((opt) => opt.value !== '').map((option) => (
                                <button
                                    ...
                                    className={`w-full admin-btn ${booking.status === option.value
