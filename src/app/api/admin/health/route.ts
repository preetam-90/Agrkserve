...
export async function GET() {
  try {
    ...
    const dbLoad = Math.min(Math.round((totalRecords / 10000) * 100) + (dbResponseTime > 100 ? 20 : 0), 100);
    ...
    const serverLoad = apiResponseTime > 200 ? 80 : apiResponseTime > 100 ? 50 : apiResponseTime > 50 ? 25 : 12;
