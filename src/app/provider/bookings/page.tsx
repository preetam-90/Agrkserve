...
import { Calendar, Clock, ChevronRight, Tractor, CheckCircle, XCircle, Search } from 'lucide-react';
                      ...
                      <Card key={booking.id} className="overflow-hidden">
                        <CardContent className="p-0">
                          <div className="flex flex-col sm:flex-row">
                            {/* Equipment Image */}
                            <div className="relative h-32 w-full flex-shrink-0 bg-gray-100 sm:h-auto sm:w-48">
                              {equipment?.images?.[0] ? (
                                <Image
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div className="col-span-2">
                  ...
                  <p className="font-medium">
                    {selectedBooking.delivery_address || 'Not specified'}
                  </p>
                </div>
