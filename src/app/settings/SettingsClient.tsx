...
export default function SettingsPage() {
  ...
  const handleSaveProfile = (e: React.FormEvent) => {
    e.preventDefault();
    toast('Profile settings coming soon', { icon: 'ℹ️' });
  };

  const handleSaveNotifications = () => {
    toast('Notification preferences coming soon', { icon: 'ℹ️' });
  };
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-[#94A3B8]">Manage your account settings and preferences</p>
            </div>
          </div>
        </div>
            ...
            <Card className="border-[#1E293B] bg-[#0F172A]/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                <div className="rounded-xl border border-[#22C55E]/30 bg-[#22C55E]/10 p-6 text-center">
                  ...
                  <h3 className="mb-2 text-lg font-bold text-[#F8FAFC]">Unlock More Features</h3>
            ...
            <Card className="border-[#1E293B] bg-[#0F172A]/80 backdrop-blur-sm">
              ...
              <CardContent>
                <form id="profile-form" onSubmit={handleSaveProfile} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="location" className="text-[#F8FAFC]">
                      Location
                    </Label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="language" className="text-[#F8FAFC]">
                      Language
                    </Label>
                    <div className="relative">
                  ...
                  <div className="space-y-3">
                    <div className="group flex items-center justify-between rounded-xl border border-[#1E293B] bg-[#1E293B]/30 p-4 transition-colors hover:bg-[#1E293B]/50">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1">
                          <Label className="cursor-pointer text-base font-semibold text-[#F8FAFC]">
                            Order Updates
                          </Label>
                      ...
                      <Switch
                        ...
                        onCheckedChange={(c) =>
                          setNotifications({ ...notifications, emailOrderUpdates: c })
                        }
                    ...
                    <div className="group flex items-center justify-between rounded-xl border border-[#1E293B] bg-[#1E293B]/30 p-4 transition-colors hover:bg-[#1E293B]/50">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(c) =>
                          setNotifications({ ...notifications, emailPromotions: c })
                        }
                        className="data-[state=checked]:bg-[#22C55E]"
                      />
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="group flex items-center justify-between rounded-xl border border-[#1E293B] bg-[#1E293B]/30 p-4 transition-colors hover:bg-[#1E293B]/50">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(c) =>
                          setNotifications({ ...notifications, pushNewMessages: c })
                        }
                        className="data-[state=checked]:bg-[#22C55E]"
                      />
                    </div>
                    <div className="group flex items-center justify-between rounded-xl border border-[#1E293B] bg-[#1E293B]/30 p-4 transition-colors hover:bg-[#1E293B]/50">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(c) =>
                          setNotifications({ ...notifications, smsReminders: c })
                        }
                        className="data-[state=checked]:bg-[#22C55E]"
                      />
                    </div>
          ...
          <TabsContent value="security" className="space-y-6">
            <Card className="border-[#1E293B] bg-[#0F172A]/80 backdrop-blur-sm">
              ...
              <CardFooter className="flex justify-end border-t border-[#1E293B] px-6 py-4">
                <Button
                  onClick={() => {
                    toast('Password change coming soon', { icon: 'ℹ️' });
                  }}
                  className="bg-gradient-to-r from-[#15803D] to-[#22C55E] text-white hover:from-[#166534] hover:to-[#16A34A]"
                >
