          ...
          >
            <div className="overflow-hidden rounded-2xl border border-red-500/20 bg-[#0f0f0f] shadow-2xl">
              ...
              <div className="flex items-center gap-3 border-b border-red-500/20 bg-red-500/10 p-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Delete Asset</h3>
                ...
                {step === 1 ? (
                  <div className="space-y-4">
                    <div className="rounded-xl border border-[#262626] bg-[#1a1a1a] p-4">
                      ...
                      <p className="font-medium text-white">{asset.public_id}</p>
                      <div className="mt-2 flex gap-4 text-xs text-neutral-500">
                        <span>Type: {asset.resource_type}</span>
                        <span>Format: {asset.format}</span>
                        <span>Size: {(asset.bytes / 1024 / 1024).toFixed(2)} MB</span>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg bg-red-500/10 p-3 text-sm text-red-400">
                      <p className="flex items-center gap-2">
                        ...
                        Warning: This will permanently delete the asset from Cloudinary
                      </p>
                    </div>
                  </div>
                ) : (
                  <div className="space-y-4">
                    <p className="text-sm text-neutral-400">
                      Please provide a reason for deletion (required for audit log):
                    </p>
                    <textarea
                      value={reason}
