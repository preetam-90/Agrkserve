...
function ProblemNarrative() {
  ...
  return (
    <section
      id="problem"
      ref={rootRef}
      className="relative bg-[#070c09] px-5 py-24 md:px-8 md:py-36"
    >
      ...
      <div className="problem-stage relative mx-auto min-h-[82vh] max-w-7xl overflow-hidden rounded-[2.2rem] border border-white/10">
        <div className="absolute inset-0 grid md:grid-cols-2">
          ...
          <div className="relative bg-[#070f0c]">
            <div className="problem-neon absolute inset-0 bg-[linear-gradient(to_right,rgba(16,185,129,0.15)_1px,transparent_1px),linear-gradient(to_bottom,rgba(16,185,129,0.15)_1px,transparent_1px)] bg-[size:4rem_4rem] opacity-0" />
          </div>
        </div>
