    ...
    <div className={cn('grid h-[calc(100vh-8rem)] grid-cols-1 gap-6 md:grid-cols-3', className)}>
        ...
        <div className="border-b border-gray-800 p-4">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="bg-[#111111] pl-9 text-white placeholder:text-gray-500"
            />
          </div>
        </div>
          ...
          <div className="flex flex-col" role="listbox" aria-label="Conversations">
            {conversations.map((conv) => (
              <button
                ...
                className={cn(
                  'flex items-center gap-3 border-b border-gray-800 p-4 text-left transition-colors last:border-0 hover:bg-[#1a1a1a]',
                  selectedConversation === conv.id && 'bg-green-950 hover:bg-green-950'
                )}
              >
                <div className="relative">
                  <Avatar src={conv.avatar} name={conv.name} />
                  {conv.online && (
                    <span className="absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-[#111111] bg-green-500"></span>
                  )}
                </div>
      ...
      >
        {selectedConversation ? (
          <>
            {/* Chat Header */}
            <div className="z-10 flex items-center justify-between border-b border-gray-800 bg-[#111111] p-4">
            ...
            {/* Messages */}
            <ScrollArea className="flex-1 bg-[#0a0a0a] p-4">
                    ...
                    <div
                      className={cn(
                        ...
                        msg.isMe
                          ...
                          : 'rounded-tl-none border border-gray-800 bg-[#111111] text-white'
                      )}
                    >
            ...
            <div className="border-t border-gray-800 bg-[#111111] p-4">
              <form onSubmit={handleSendMessage} className="flex gap-2">
                ...
                <Input
                  ...
                  className="flex-1 border-gray-700 bg-[#1a1a1a] text-white placeholder:text-gray-500"
          ...
          <div className="flex flex-1 flex-col items-center justify-center bg-[#0a0a0a] p-8 text-center">
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-green-900">
              <Send className="h-8 w-8 text-green-500" />
            </div>
            <h3 className="mb-2 text-xl font-semibold text-white">Select a Conversation</h3>
