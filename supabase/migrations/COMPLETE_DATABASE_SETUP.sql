-- =====================================================
-- AGRISERVE - COMPLETE DATABASE SETUP
-- =====================================================
...
-- =====================================================
-- STEP 8: CREATE TRIGGERS (Non-Auth Triggers First)
-- =====================================================
...
-- =====================================================
-- STEP 8B: CREATE AUTH TRIGGERS (After tables exist)
-- =====================================================
...
-- Add to realtime publication (if it fails, enable manually in Supabase Dashboard)
DO $$ BEGIN
  ALTER PUBLICATION supabase_realtime ADD TABLE public.bookings;
EXCEPTION WHEN others THEN
  RAISE NOTICE 'Could not add bookings to realtime: Enable in Dashboard → Database → Replication';
END $$;

DO $$ BEGIN
  ALTER PUBLICATION supabase_realtime ADD TABLE public.equipment;
EXCEPTION WHEN others THEN
  RAISE NOTICE 'Could not add equipment to realtime: Enable in Dashboard → Database → Replication';
END $$;

DO $$ BEGIN
  ALTER PUBLICATION supabase_realtime ADD TABLE public.messages;
EXCEPTION WHEN others THEN
  RAISE NOTICE 'Could not add messages to realtime: Enable in Dashboard → Database → Replication';
END $$;

DO $$ BEGIN
  ALTER PUBLICATION supabase_realtime ADD TABLE public.notifications;
EXCEPTION WHEN others THEN
  RAISE NOTICE 'Could not add notifications to realtime: Enable in Dashboard → Database → Replication';
END $$;

DO $$ BEGIN
  ALTER PUBLICATION supabase_realtime ADD TABLE public.notification_preferences;
EXCEPTION WHEN others THEN
  RAISE NOTICE 'Could not add notification_preferences to realtime: Enable in Dashboard → Database → Replication';
END $$;

-- =====================================================
-- STEP 12: SETUP STORAGE BUCKETS
-- =====================================================
...
-- =====================================================
-- STEP 14: ADD FOREIGN KEY CONSTRAINTS FOR NOTIFICATIONS
-- =====================================================
...
EXCEPTION WHEN duplicate_object THEN
  RAISE NOTICE 'FK constraint fk_notifications_booking already exists';
END $$;
...
EXCEPTION WHEN duplicate_object THEN
  RAISE NOTICE 'FK constraint fk_notifications_equipment already exists';
END $$;
...
BEGIN
  ...
  RAISE NOTICE '      → Database → Replication → Enable for tables';
  RAISE NOTICE '   2. Configure Authentication:';
  RAISE NOTICE '      → Authentication → Providers → Enable Email & Google';
  RAISE NOTICE '   3. Add Site URL in Authentication settings:';
  RAISE NOTICE '      → http://localhost:3000 (development)';
  RAISE NOTICE '      → Your production URL (when deploying)';
  RAISE NOTICE '   4. Update your .env.local file with:';
