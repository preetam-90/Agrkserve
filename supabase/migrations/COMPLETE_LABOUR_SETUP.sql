...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN daily_rate NUMERIC NOT NULL DEFAULT 0;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN hourly_rate NUMERIC;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN experience_years INTEGER NOT NULL DEFAULT 0;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN skills TEXT[] NOT NULL DEFAULT '{}';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN location_name TEXT;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN latitude DOUBLE PRECISION;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN longitude DOUBLE PRECISION;
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                   WHERE table_schema = 'public' 
                   AND table_name = 'labour_profiles' 
                   AND column_name = 'service_radius_km') THEN
        ALTER TABLE public.labour_profiles ADD COLUMN service_radius_km INTEGER DEFAULT 50;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN bio TEXT;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN average_rating NUMERIC DEFAULT 0;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN review_count INTEGER DEFAULT 0;
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                   WHERE table_schema = 'public' 
                   AND table_name = 'labour_profiles' 
                   AND column_name = 'total_jobs') THEN
        ALTER TABLE public.labour_profiles ADD COLUMN total_jobs INTEGER DEFAULT 0;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN is_verified BOOLEAN DEFAULT FALSE;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN is_active BOOLEAN DEFAULT TRUE;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN availability labour_availability DEFAULT 'available';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN location GEOGRAPHY(Point, 4326);
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN certifications TEXT[] DEFAULT '{}';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN created_at TIMESTAMPTZ DEFAULT NOW();
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ALTER TABLE public.labour_profiles ADD COLUMN updated_at TIMESTAMPTZ DEFAULT NOW();
    END IF;
    
EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE 'Table labour_profiles setup completed with possible warnings: %', SQLERRM;
END $$;
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE 'Table labour_bookings already exists or error occurred: %', SQLERRM;
END $$;
...
CREATE INDEX IF NOT EXISTS idx_labour_profiles_active ON public.labour_profiles(is_active);
...
-- Drop existing functions with explicit signatures to avoid duplicates
DROP FUNCTION IF EXISTS search_labour_nearby(
    DOUBLE PRECISION,
    DOUBLE PRECISION,
    INTEGER,
    TEXT[],
...
DROP FUNCTION IF EXISTS count_labour_nearby(
    DOUBLE PRECISION,
    DOUBLE PRECISION,
    INTEGER,
    TEXT[],
...
DROP FUNCTION IF EXISTS create_labour_profile(
    UUID,
    TEXT[],
    INTEGER,
    NUMERIC,
...
DROP FUNCTION IF EXISTS update_labour_profile_with_location(
    UUID,
    TEXT[],
    INTEGER,
    NUMERIC,
...
-- Drop any remaining overloads by name (safety net)
DO $$
DECLARE
    fn_record RECORD;
BEGIN
    ...
    LOOP
        EXECUTE format('DROP FUNCTION IF EXISTS %I.%I(%s);', fn_record.schema_name, fn_record.function_name, fn_record.args);
    END LOOP;
END $$;
...
DO $$
BEGIN
    RAISE NOTICE 'Labour system setup completed successfully!';
    RAISE NOTICE 'Tables created: labour_profiles, labour_bookings';
    RAISE NOTICE 'Functions created: search_labour_nearby, count_labour_nearby, create_labour_profile, update_labour_profile_with_location';
END $$;
